...
export const contactSchema = z.object({
  ...
  // Honeypot. Deliberately permissive: rejecting a filled value here would fail
  // validation and hand the bot a 422 naming this field. The route accepts the
  // submission and drops it silently instead.
